...
public class ServoPerceptionModule : ModuleBase
{
    ...
    public int HandThreshold = 120;
    public int WristThreshold = 120;
    ...
    protected void Update()
    {
        ...
        if (rightArmExists)
        {
            ...
            if (handRightAngles.Max() - handRightAngles.Min() > HandThreshold || wristRightAngles.Max() - wristRightAngles.Min() > WristThreshold)
            {
        ...
        if (leftArmExists)
        {
            ...
            if (handLeftAngles.Max() - handLeftAngles.Min() > HandThreshold || wristLeftAngles.Max() - wristLeftAngles.Min() > WristThreshold)
            {
