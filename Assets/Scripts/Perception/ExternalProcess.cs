...
public class ExternalProcess
{
	...
	/// <summary>
	/// Whether to redirect to standard out.
	/// </summary>
	...
	/// <param name="redirectStandardOutput">Whether to capture and log to stdout</param>
	public ExternalProcess(string pathToExecutable, string arguments, bool redirectStandardOutput)
	{
		...
		errorLog.AppendFormat("{0} {1}: ", pathToExecutable, arguments);
		if (RedirectStandardOutput)
		{
			outputLog = new StringBuilder();
			outputLog.AppendFormat("{0} {1}: ", pathToExecutable, arguments);
		}
	}
